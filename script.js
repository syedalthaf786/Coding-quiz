...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayScoreMessage(score) {
        if (score > 20) {
            scoreElement.textContent = `Excellent try! Your score is ${score}. Try again!`;
        } else if (score > 15) {
            scoreElement.textContent = `Good job! Your score is ${score}. Try again!`;
        } else {
            scoreElement.textContent = `Your score is ${score}. Try again!`;
        }
    }
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Attempt ${index + 1} Details</h5>
              ...
              <div class="modal-body">
                ...
                <p>Timestamp: ${attempt.timestamp}</p>
              </div>
